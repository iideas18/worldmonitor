...
export const VARIANT_META: { full: VariantMeta; [k: string]: VariantMeta } = {
  ...
  china: {
    title: 'China Monitor - 中国市场实时监控',
    description: 'Real-time China financial monitor tracking Shanghai, Shenzhen, Hong Kong markets, A-shares, yuan forex, Chinese tech stocks, commodities, and economic indicators.',
    keywords: 'China markets, A-shares, Shanghai composite, Shenzhen, Hong Kong, Hang Seng, CSI 300, yuan, CNY, Chinese stocks, China ETF, PBOC, Chinese economy, trade war, Belt and Road, tech stocks, Alibaba, Tencent, commodity markets, China GDP',
    url: 'https://china.worldmonitor.app/',
    siteName: 'China Monitor',
    shortName: 'ChinaMonitor',
    subject: 'China Markets, Chinese Economy, and Financial Intelligence',
    classification: 'China Finance Dashboard, Market Tracker, Economic Intelligence',
    categories: ['finance', 'news'],
    features: [
      ...
      'A-share tracking',
      'Yuan forex rates',
      'China ETF monitoring',
      'PBOC policy watch',
      'Chinese tech stocks',
      'Commodity price tracking',
      'Economic indicator alerts',
      'Trade policy monitoring',
      'Belt and Road tracking',
